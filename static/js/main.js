...
$(function() {
  $("#UIST2020-Programmable-button #citation-bibtex").click( function() {
    if ($(this).text().includes("BIBTEX")) {
      $("#UIST2020-Programmable-button .description").html("@inproceedings{Park2020:Augmentedbutton,<br>&nbsp;&nbsp;author = {Parck, Chaeyong and Yoon, Jinhyuk and Oh, Seungjae and Choi, Seungmoon},<br>&nbsp;&nbsp;title = {Augmenting Physical Buttons with Vibrotactile Feedback for Programmable Feels},<br>&nbsp;&nbsp;year = {2020},<br>&nbsp;&nbsp;isbn = {-},<br>&nbsp;&nbsp;publisher = {Association for Computing Machinery},<br>&nbsp;&nbsp;address = {New York, NY, USA},<br>&nbsp;&nbsp;url = {https://doi.org/10.1145/3379337.3415837},<br>&nbsp;&nbsp;doi = {10.1145/3379337.3415837},<br>&nbsp;&nbsp;booktitle = {Proceedings of the 2019 CHI Conference on Human Factors in Computing Systems},<br>&nbsp;&nbsp;pages = {1–14},<br>&nbsp;&nbsp;numpages = {14},<br>&nbsp;&nbsp;keywords = {Button; Vibrotactile; Haptics; Augmented reality; Multimodal},<br>&nbsp;&nbsp;location = {Virtual Event, USA},<br>&nbsp;&nbsp;series = {UIST '20}<br>}");
      $(this).html("<i class=\"tiny material-icons left\">autorenew</i>CITATION");
    } else {
